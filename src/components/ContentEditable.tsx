...
interface IContentEditableProps {
  value: string
  onChange?(e: React.ChangeEvent<HTMLDivElement>): unknown
  className?: string
}
...
export function ContentEditable({ onChange, value, className, ...props }: IContentEditableProps) {
  ...
  return <div {...props} className={className} ref={textareaEl} contentEditable suppressContentEditableWarning onInput={handleChange}></div>
}
