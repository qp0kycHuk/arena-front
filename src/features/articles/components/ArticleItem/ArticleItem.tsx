...
export function ArticleItemPlacehlder() {
    return (
        <div className="flex items-center py-3">
            ...
            <div className='max-w-5xl ml-4'>
                <div className="mb-3 w-64 h-5 bg-opacity-50 animate-pulse bg-gray" />
                <div className="max-w-md ">
                    <div className="mb-2 w-64 h-2 bg-opacity-50 animate-pulse bg-gray" />
                    <div className="w-64 h-2 bg-opacity-50 animate-pulse bg-gray" />
                </div>
            </div>
            <div className="ml-auto">
                <div className="w-24 h-3 ml-1 bg-opacity-50 animate-pulse bg-gray mb-1" />
