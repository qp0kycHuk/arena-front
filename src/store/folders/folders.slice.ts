...
export const foldersSlice = createSlice({
  ...
  extraReducers(builder) {
    builder.addCase(fetchFolders.pending, foldersEntityAdapter.removeAll)
...
export const { selectEntities, selectAll, selectById } = foldersEntityAdapter.getSelectors<RootState>(({ folders }) => folders)
