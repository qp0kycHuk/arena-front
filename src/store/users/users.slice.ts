...
export const usersSlice = createSlice({
  ...
  extraReducers(builder) {
    builder.addCase(fetchUsers.pending, usersEntityAdapter.removeAll)
...
export const { selectEntities, selectAll, selectById } = usersEntityAdapter.getSelectors<RootState>(({ users }) => users)
