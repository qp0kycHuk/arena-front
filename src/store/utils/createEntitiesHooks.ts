...
interface IOptions<E, C, U> {
  fetchAllThunk: AsyncThunk<E[], void, NonNullable<unknown>>
  updateThunk: AsyncThunk<E, U, NonNullable<unknown>>
  removeThunk: AsyncThunk<EntityId, EntityId, NonNullable<unknown>>
  createThunk: AsyncThunk<E, C, NonNullable<unknown>>
  fetchByIdThunk: AsyncThunk<E, EntityId, NonNullable<unknown>>
